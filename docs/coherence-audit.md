...
- [~] T1.10 (hero-split, hero-section, grid-banner done; dove-ritiri 0 gap pending) Two-button gaps: 1rem / 8px / 0 → `--modus-space-xs`; grid-banner 2-button cards stack full width on mobile (Pizzerie, dove-ritiri).
