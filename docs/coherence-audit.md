...
- [x] The 17 orphaned duplicate product templates were confirmed one by one (client, 2026-09-25) — each live product now uses a renamed pasta-*/vino-*/liquore-* template, the old bare-name template was leftover — and deleted from the draft via Shopify admin (themeFilesDelete is blocked for this MCP session on any theme). Backups of all 17 kept in theme-backups/2026-09-25-deleted-templates/. Verified gone from the draft after deletion.
